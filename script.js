// den Array hier drunter UNBEDINGT einklappen
const woerter = [
    "aales",
    "aalst",
    "aalte",
...
let anzahlWoerter = 0;
const richtigesWort = woerter[Math.floor(Math.random() * woerter.length)];
console.log(richtigesWort);
    ...
    if (anzahlWoerter < 6 && !wortErraten) {
        ...
        if (woerter.includes(eingegebenesWort)) {
            ...
            for (let i = 1; i < 6; i++) {
                ...
                if (eingegebenesWort.charAt(i - 1) == richtigesWort.charAt(i - 1)) {
                    document.getElementById(`w${anzahlWoerter}${i}`).style.backgroundColor = "#6aaa64";

                } else if (richtigesWort.indexOf(eingegebenesWort.charAt(i - 1)) != -1) {
